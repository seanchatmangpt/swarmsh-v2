...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("SwarmSH v2 Telemetry Code Generator (Standalone)");
...
impl TelemetryGenerator {
    ...
    fn load_semantic_conventions(&self) -> Result<HashMap<String, SemanticConvention>, Box<dyn std::error::Error>> {
    ...
    fn generate_attributes_rs(&self, conventions: &HashMap<String, SemanticConvention>) -> Result<String, Box<dyn std::error::Error>> {
        let mut lines = vec![
    ...
    fn generate_span_builders_rs(&self, conventions: &HashMap<String, SemanticConvention>) -> Result<String, Box<dyn std::error::Error>> {
        let mut lines = vec![
    ...
    fn generate_metrics_rs(&self, conventions: &HashMap<String, SemanticConvention>) -> Result<String, Box<dyn std::error::Error>> {
        let mut lines = vec![
